...
if (!file_exists("report/audience2.csv"))
    $fileTextFile1 = fopen ("report/audience2.csv",'w');
else
    $fileTextFile1 = fopen ("report/audience2.csv",'a');

fwrite($fileTextFile1,"Audience\r\n");
fwrite($fileTextFile1,"UserID,Firstname,Lastname,Institue\r\n");
   
include "connectdb.php";
$SQL = "SELECT * FROM user,register WHERE user.user_id = register.user_id AND attendance_type = 'audience' AND register_type ='Early bird without workshops'"; 
